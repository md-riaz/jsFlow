...
const SCENARIOS = {
  ...
  callcenter: {
    nodes: [
      ...
      { id: 'ivr',         type: 'decision',  x: 840, y: 200, width: 200, data: { label: 'IVR Menu',           icon: '☎',  description: 'DTMF menu prompt' } },
    ...
    edges: [
      ...
      { id: 'e6',  source: 'ivr',       sourceHandle: 'out', target: 'sales',      targetHandle: 'in', label: 'press 1', type: 'bezier' },
      { id: 'e7',  source: 'ivr',       sourceHandle: 'out', target: 'support',    targetHandle: 'in', label: 'press 2', type: 'bezier' },
      { id: 'e8',  source: 'ivr',       sourceHandle: 'out', target: 'extension',  targetHandle: 'in', label: 'press 3', type: 'bezier' },
      { id: 'e9',  source: 'ivr',       sourceHandle: 'out', target: 'voicemail',  targetHandle: 'in', label: 'press 0 / timeout', type: 'bezier' },
